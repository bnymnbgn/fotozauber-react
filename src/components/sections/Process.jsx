...
const Process = () => {
  ...
  const steps = [
    {
      ...
      description: 'Laden Sie Ihre Lieblingsbilder ganz einfach über unser sicheres Upload-System hoch.',
      details: [
    ...
    },
    {
      ...
      description: 'Persönliche Beratung über Ihre Wünsche. Welches magische Thema soll es werden?',
      details: [
    ...
    },
    {
      ...
      description: 'Wir erstellen ein detailliertes Konzept und zeigen Ihnen den geplanten Bearbeitungsweg.',
      details: [
    ...
    },
    {
      ...
      description: 'Unsere Künstler erwecken Ihre Vision zum Leben und erschaffen einzigartige Kunstwerke.',
      details: [
    ...
    },
    {
      ...
      description: 'Sie erhalten eine erste Vorschau zur Begutachtung und können Änderungswünsche äußern.',
      details: [
    ...
    },
    {
      ...
      description: 'Nach Ihrer Freigabe führen wir die finalen Anpassungen durch und optimieren alle Details.',
      details: [
    ...
    },
    {
      ...
      description: 'Ihre fertigen Kunstwerke werden in höchster Qualität zum Download bereitgestellt.',
      details: [
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && window.gsap) {
      ...
      .from('.step-transition p', {
        opacity: 0,
        y: 20,
        duration: 0.4,
        ease: "power2.out"
      }, "-=0.3")
      .from('.step-transition ul li', {
        opacity: 0,
        x: -20,
        duration: 0.3,
        stagger: 0.1,
  ...
  const features = [
    {
      ...
      description: 'Bis zu 3 kostenlose Korrekturen bis Sie 100% zufrieden sind'
    },
    {
      icon: Clock,
  ...
  return (
    <section id="process" className="section-padding bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Von der ersten Idee bis zum fertigen Kunstwerk - so einfach und transparent 
            ist der Weg zu Ihren magischen Erinnerungen.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto mb-20"
              ...
              <div className="grid grid-cols-7 gap-4">
                {steps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      {/* Step Circle */}
                      <div className={`relative z-10 w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center transition-all duration-500 transform ${
                      ...
                      <div className="text-center">
                        ...
                        <div className={`inline-flex items-center space-x-1 text-xs font-medium px-2 py-1 rounded-full ${
          ...
          <div className="lg:hidden space-y-8">
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.id} className="bg-white rounded-2xl shadow-lg p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className={`text-xs font-medium px-2 py-1 rounded-full ${step.bgColor}`}>
                          {step.duration}
                        </span>
                      </div>
        ...
        <div className="text-center bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-8 md:p-12 text-white">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Starten Sie noch heute Ihre magische Transformation. 
            Der Upload Ihrer Bilder dauert nur wenige Minuten.
          </p>

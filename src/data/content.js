...
export const faqData = [
  {
    ...
    answer:
      "Die Bearbeitung dauert in der Regel 3-7 Werktage, abhängig von der Komplexität des gewünschten Effekts.",
  },
  {
    id: 2,
    question: "Welche Dateiformate werden unterstützt?",
    answer:
      "Wir akzeptieren JPEG, PNG, TIFF und RAW-Dateien. Die fertigen Bilder erhalten Sie in hoher Auflösung als JPEG oder PNG.",
  },
  {
    id: 3,
    question: "Kann ich Änderungswünsche äußern?",
    answer:
      "Ja, gerne! Wir bieten bis zu 3 kostenlose Korrekturschleifen, um sicherzustellen, dass das Ergebnis Ihren Vorstellungen entspricht.",
  },
  {
    id: 4,
    question: "Sind die Bilder für den Druck geeignet?",
    answer:
      "Absolut! Alle bearbeiteten Bilder werden in hoher Auflösung (300 DPI) geliefert und sind perfekt für den professionellen Druck geeignet.",
  },
];
